...
import time
import winsound
##按照之前教程安装好依赖库后，将以下文件的路径换为自己电脑上对应文件所在位置的路径
face_cascade = cv2.CascadeClassifier(r'D:\python36\Lib\site-packages\cv2\data\haarcascade_frontalface_alt.xml')
Leye_cascade = cv2.CascadeClassifier(r'D:\python36\Lib\site-packages\cv2\data\haarcascade_lefteye_2splits.xml')
Reye_cascade = cv2.CascadeClassifier(r'D:\python36\Lib\site-packages\cv2\data\haarcascade_righteye_2splits.xml')
eye_cascade  = cv2.CascadeClassifier(r'D:\python36\Lib\site-packages\cv2\data\haarcascade_eye.xml')
...
#        frame = cv2.imread(r'C:\Users\luxinfeng\Downloads\Fatigue-Detection-master\binary_thresholding\face_img.jpg')
